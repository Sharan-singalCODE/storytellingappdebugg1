...
export default class CreateStory extends Component {
  ...
  async addStory(){
    ...
    await firebase.database().ref("/posts/"+(Math.random().toString(36).slice(2)))
      ...
      alert("Please fill all the details to post!")
    }
  }
  componentDidMount() {
            ...
            <ScrollView>
             ...
             <View style={{ height: RFValue(this.state.dropdownHeight) }}>
                <DropDownPicker
                  ...
                  dropDownStyle={ this.state.light_theme?styles.dropdownLabelLight:styles.dropdownLabel}
                  labelStyle={
              ...
              <TextInput
                ...
                onChangeText={a => this.setState({ story:a })}
                placeholder={"Story"}
                multiline={true}
                numberOfLines={20}
                placeholderTextColor="white"
              ...
              <TextInput
                ...
                onChangeText={a => this.setState({ moral:a })}
